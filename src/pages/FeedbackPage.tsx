...
export const FeedbackPage: React.FC = () => {
    return (
        <div className="container" style={{ padding: '4rem 0', maxWidth: '100%', overflowX: 'hidden', boxSizing: 'border-box' }}>
            ...
            <div className="glass-panel" style={{ padding: '2rem', borderRadius: 'var(--radius-lg)', overflow: 'hidden', maxWidth: '100%' }}>
                <iframe
                    ...
                    marginHeight={0}
                    marginWidth={0}
                    style={{ border: 'none', borderRadius: 'var(--radius-md)', maxWidth: '100%', display: 'block' }}
                >
                    載入中…
                </iframe>
            </div>
