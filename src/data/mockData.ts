...
export const LOCATIONS: Location[] = [
  ...
  {
    id: 'jp-osaka-17',
    name: '生野韓國城 (Ikuno Korea Town)',
    country: 'JP',
    category: 'Public Facility',
    address: 'Momodani, Ikuno Ward, Osaka',
    city: 'Osaka',
    imageUrl: mallImg,
    amenities: ['family_toilet'],
    description: '這裡主要是韓國風格小店：韓國零食、時尚、雜貨。非常適合家庭一起逛文化市集式的地方。',
    openingHours: '10:00 - 18:00',
    websiteUrl: 'https://ikuno-koreatown.com/',
    coordinates: { lat: 34.6590, lng: 135.5300 }
  },
