...
export const LOCATIONS: Location[] = [
  ...
  {
    id: 'jp-osaka-1',
    name: '阪急百貨 梅田本店 (Hankyu Umeda Main Store)',
    country: 'JP',
    category: 'Department Store',
  ...
  {
    id: 'jp-osaka-2',
    name: '大丸 梅田店 (Daimaru Umeda)',
    country: 'JP',
    category: 'Department Store',
    address: '3 Chome-1-1 Umeda, Kita Ward, Osaka',
    city: 'Osaka',
    imageUrl: mallImg,
    amenities: ['nursing_room', 'elevator', 'diaper_changing', 'family_toilet'],
    description: '大型百貨，可買伴手禮、兒童用品。',
    openingHours: '10:00 - 20:00',
    websiteUrl: 'https://www.daimaru.co.jp/umedamise/',
    coordinates: { lat: 34.7017, lng: 135.4966 }
  },
  {
    id: 'jp-osaka-3',
    name: 'HEP FIVE',
    ...
    imageUrl: mallImg,
    amenities: ['nursing_room', 'elevator', 'diaper_changing', 'family_toilet', 'stroller_rental'],
    description: '非常親子友善，有摩天輪（孩子會很喜歡）、哺乳室、嬰兒車免費租借等服務。',
    openingHours: '11:00 - 21:00',
    websiteUrl: 'https://www.hepfive.jp/',
    coordinates: { lat: 34.7035, lng: 135.5002 }
  },
  {
    id: 'jp-osaka-4',
    ...
    imageUrl: mallImg,
    amenities: ['nursing_room', 'elevator', 'diaper_changing', 'family_toilet', 'play_area'],
    description: '大型購物中心 +辦公 +生活設施，非常寬敞適合家庭逛。',
    openingHours: '11:00 - 21:00',
    websiteUrl: 'https://www.gfo.co.jp/',
    coordinates: { lat: 34.7040, lng: 135.4945 }
  },
  {
    id: 'jp-osaka-5',
    name: '大丸 心齋橋店 (Daimaru Shinsaibashi)',
    country: 'JP',
    category: 'Department Store',
    address: '1 Chome-7-1 Shinsaibashisuji, Chuo Ward, Osaka',
    city: 'Osaka',
    imageUrl: mallImg,
    amenities: ['nursing_room', 'elevator', 'diaper_changing', 'family_toilet'],
    description: '老字號百貨，品牌多樣，適合家庭購物。',
    openingHours: '10:00 - 20:00',
    websiteUrl: 'https://www.daimaru.co.jp/shinsaibashi/',
    coordinates: { lat: 34.6737, lng: 135.5003 }
  },
  {
    id: 'jp-osaka-6',
    name: '心齋橋 PARCO',
    country: 'JP',
    category: 'Department Store',
    address: '1 Chome-8-3 Shinsaibashisuji, Chuo Ward, Osaka',
    city: 'Osaka',
    imageUrl: mallImg,
    amenities: ['nursing_room', 'elevator', 'diaper_changing', 'family_toilet'],
    description: '約 150 間店，流行、動漫、餐廳都有，非常適合帶孩子來看角色商品、逛街。',
    openingHours: '10:00 - 20:00',
    websiteUrl: 'https://shinsaibashi.parco.jp/',
    coordinates: { lat: 34.6734, lng: 135.5006 }
  },
  {
    id: 'jp-osaka-7',
    name: '東急 Hands 心齋橋店',
    country: 'JP',
    category: 'Department Store',
    address: '3 Chome-4-12 Minamisenba, Chuo Ward, Osaka',
    city: 'Osaka',
    imageUrl: mallImg,
    amenities: ['elevator', 'family_toilet'],
    description: '創意雜貨、手作小物、文具玩具都很豐富，孩子可能會很有興趣。',
    openingHours: '10:00 - 20:00',
    websiteUrl: 'https://shinsaibashi.tokyu-hands.co.jp/',
    coordinates: { lat: 34.6750, lng: 135.5000 }
  },
  {
    id: 'jp-osaka-8',
    name: '高島屋 難波店 (Takashimaya Osaka)',
    country: 'JP',
    category: 'Department Store',
    ...
    imageUrl: mallImg,
    amenities: ['nursing_room', 'elevator', 'diaper_changing', 'family_toilet', 'stroller_rental'],
    description: '百貨內有餐飲、兒童／家庭商品。',
    openingHours: '10:00 - 20:00',
    websiteUrl: 'https://www.takashimaya.co.jp/osaka/',
    coordinates: { lat: 34.6645, lng: 135.5015 }
  },
  {
    id: 'jp-osaka-9',
    name: 'Namba CITY',
    country: 'JP',
    category: 'Department Store',
    address: '5 Chome-1-60 Nanba, Chuo Ward, Osaka',
    city: 'Osaka',
    imageUrl: mallImg,
    amenities: ['nursing_room', 'elevator', 'diaper_changing', 'family_toilet'],
    description: '大型商場型購物中心，可逛衣服、日用、雜貨，非常適合家庭一起。',
    openingHours: '11:00 - 21:00',
    websiteUrl: 'http://www.nambacity.com/',
    coordinates: { lat: 34.6630, lng: 135.5020 }
  },
  {
    id: 'jp-osaka-10',
    name: 'Namba Parks',
    ...
    imageUrl: mallImg,
    amenities: ['nursing_room', 'elevator', 'diaper_changing', 'family_toilet', 'play_area'],
    description: '購物＋綠意空間；屋頂花園讓孩子可以稍微跑跑、放鬆，是非常適合親子的複合商場。',
    openingHours: '11:00 - 21:00',
    websiteUrl: 'http://www.nambaparks.com/',
    coordinates: { lat: 34.6615, lng: 135.5018 }
  },
  {
    id: 'jp-osaka-11',
    name: '天神橋筋商店街',
    ...
    imageUrl: mallImg,
    amenities: ['family_toilet'],
    description: '這是一條非常長、非常在地的商店街，有很多小店、小吃攤、雜貨店，適合家庭散步、探索當地生活風情。',
    openingHours: '10:00 - 20:00',
    websiteUrl: 'https://www.tenjin123.com/',
    coordinates: { lat: 34.7060, lng: 135.5100 }
  },
  {
    id: 'jp-osaka-12',
    name: '臨空城 Premium Outlets (Rinku)',
    country: 'JP',
    category: 'Department Store',
    address: '3-28 Rinkuoraiminami, Izumisano, Osaka',
    city: 'Osaka',
    imageUrl: mallImg,
    amenities: ['nursing_room', 'elevator', 'diaper_changing', 'family_toilet', 'stroller_rental', 'play_area'],
    description: '大型折扣 outlet，國際品牌 +儿童服飾都有。非常適合親子一起來血拼折扣品牌。',
    openingHours: '10:00 - 20:00',
    websiteUrl: 'https://www.premiumoutlets.co.jp/rinku/',
    coordinates: { lat: 34.4068, lng: 135.2951 }
  },
  {
    id: 'jp-osaka-13',
    name: '日本橋 / Den-Den Town',
    country: 'JP',
    category: 'Public Facility',
    ...
    imageUrl: mallImg,
    amenities: ['family_toilet'],
    description: '日本橋本身是動漫、電器街，非常適合青少年或對動漫/遊戲/模型有興趣的小孩。整條街逛起來很有趣，是文化+購物並存的地方。',
    openingHours: '10:00 - 20:00',
    websiteUrl: '',
    coordinates: { lat: 34.6580, lng: 135.5060 }
  },
  {
    id: 'jp-osaka-14',
    name: '堀江 (Horie)',
    country: 'JP',
    category: 'Public Facility',
    address: 'Horie, Nishi Ward, Osaka',
    city: 'Osaka',
    imageUrl: mallImg,
    amenities: ['family_toilet'],
    description: '設計師小店、文青品牌、特色雜貨非常多。商店街型態適合慢慢逛，也很適合父母和孩子一起挑小禮物或手作小物。',
    openingHours: '11:00 - 20:00',
    websiteUrl: '',
    coordinates: { lat: 34.6720, lng: 135.4930 }
  },
  {
    id: 'jp-osaka-15',
    name: '道頓堀 / 戎橋 (Don Quijote)',
    country: 'JP',
    category: 'Department Store',
    address: 'Dotonbori, Chuo Ward, Osaka',
    city: 'Osaka',
    imageUrl: mallImg,
    amenities: ['family_toilet', 'elevator'],
    description: '可以順道逛 Don Quijote（唐吉軻德）道頓堀店。這種大型折扣店裡有零食、玩具、紀念品，非常吸引小孩子。街道本身是大阪經典打卡點。',
  ...
  },
  {
    ...
    imageUrl: parkImg,
    amenities: ['family_toilet'],
    description: '潮流古著、小眾品牌店多，對於喜歡特色/復古風的小孩（或青少年）來說很有趣。有街頭藝術氛圍、時尚小店。',
    openingHours: '11:00 - 20:00',
    websiteUrl: 'https://americamura.jp/',
    coordinates: { lat: 34.6710, lng: 135.4980 }
  },
  ...
  // ==========================================
  {
    ...
    imageUrl: mallImg,
    amenities: ['family_toilet'],
    description: '很適合親子一起逛：可以買京都特色食材、小吃、和風零食。小孩可以體驗「京都人的廚房」感。',
    openingHours: '10:00 - 18:00',
    websiteUrl: 'https://www.kyoto-nishiki.or.jp/',
    coordinates: { lat: 35.0050, lng: 135.7631 }
  },
  {
    id: 'jp-kyoto-2',
    name: '新京極商店街 (Shinkyogoku Shopping Arcade)',
    country: 'JP',
    category: 'Public Facility',
    address: 'Shinkyogoku-dori, Nakagyo Ward, Kyoto',
    city: 'Kyoto',
    imageUrl: mallImg,
    amenities: ['family_toilet'],
    description: '遮雨棚商街，店鋪豐富：紀念品、小飾品、小吃都很多，適合小孩與大人一起慢慢逛。',
    openingHours: '10:00 - 21:00',
    websiteUrl: 'https://www.shinkyogoku.or.jp/',
    coordinates: { lat: 35.0045, lng: 135.7670 }
  },
  {
    id: 'jp-kyoto-3',
    name: '寺町京極商店街 (Teramachi Shopping Arcade)',
    country: 'JP',
    category: 'Public Facility',
    ...
    imageUrl: mallImg,
    amenities: ['family_toilet'],
    description: '傳統 +文創店鋪很多：可以讓小孩看藝術、繪畫小物、和風禮品。街道風格優雅，是親子悠閒逛街的好區。',
    openingHours: '10:00 - 21:00',
    websiteUrl: 'https://www.teramachi-keizai.jp/',
    coordinates: { lat: 35.0045, lng: 135.7660 }
  },
  {
    id: 'jp-kyoto-4',
    name: '京都 高島屋 (Takashimaya Kyoto)',
    country: 'JP',
    category: 'Department Store',
    address: '52 Nishiiru Shincho, Shijo-dori Kawaramachi, Shimogyo Ward, Kyoto',
    city: 'Kyoto',
    imageUrl: mallImg,
    amenities: ['nursing_room', 'elevator', 'diaper_changing', 'family_toilet', 'stroller_rental'],
    description: '高檔品牌 +兒童用品 +餐飲，都很適合家庭購物。',
    openingHours: '10:00 - 20:00',
    websiteUrl: 'https://www.takashimaya.co.jp/kyoto/',
    coordinates: { lat: 35.0035, lng: 135.7685 }
  },
  {
    id: 'jp-kyoto-5',
    name: '大丸 京都店 (Daimaru Kyoto)',
    country: 'JP',
    category: 'Department Store',
    address: '79 Tachiuri Nishimachi, Shijo-dori Takakura Nishiiru, Shimogyo Ward, Kyoto',
    city: 'Kyoto',
    imageUrl: mallImg,
    amenities: ['nursing_room', 'elevator', 'diaper_changing', 'family_toilet'],
    description: '老字號，有伴手禮、美食也齊，非常適合親子。',
    openingHours: '10:00 - 20:00',
    websiteUrl: 'https://www.daimaru.co.jp/kyoto/',
    coordinates: { lat: 35.0038, lng: 135.7615 }
  },
  {
    id: 'jp-kyoto-6',
    name: '藤井大丸 (Fujii Daimaru)',
    country: 'JP',
    category: 'Department Store',
    address: '605 Teianmaenocho, Shijo-dori Teramachi Higashiiru, Shimogyo Ward, Kyoto',
    city: 'Kyoto',
    imageUrl: mallImg,
    amenities: ['nursing_room', 'elevator', 'diaper_changing', 'family_toilet'],
    description: '年輕設計、甜點 (Harbs) 非常適合小孩休息、吃點心。',
    openingHours: '10:30 - 20:00',
    websiteUrl: 'https://www.fujiidaimaru.co.jp/',
    coordinates: { lat: 35.0033, lng: 135.7665 }
  },
  {
    id: 'jp-kyoto-7',
    name: '河原町 OPA',
    country: 'JP',
    category: 'Department Store',
    address: '385 Komeyacho, Shijo-dori Kawaramachi Agaru, Nakagyo Ward, Kyoto',
    city: 'Kyoto',
    imageUrl: mallImg,
    amenities: ['elevator', 'family_toilet'],
    description: '流行品牌、平價商品，適合年輕家庭。',
    openingHours: '11:00 - 21:00',
    websiteUrl: 'https://www.opa-club.com/kawaramachi',
    coordinates: { lat: 35.0042, lng: 135.7688 }
  },
  {
    id: 'jp-kyoto-8',
    name: '京都 BAL',
    country: 'JP',
    category: 'Department Store',
    address: '251 Yamazaki-cho, Kawaramachi-dori Sanjo Sagaru, Nakagyo Ward, Kyoto',
    city: 'Kyoto',
    imageUrl: mallImg,
    amenities: ['nursing_room', 'elevator', 'diaper_changing', 'family_toilet'],
    description: '質感設計品牌與生活雜貨，逛起來輕鬆舒服。',
    openingHours: '11:00 - 20:00',
    websiteUrl: 'https://www.bal-bldg.com/kyoto/',
    coordinates: { lat: 35.0065, lng: 135.7690 }
  },
  {
    id: 'jp-kyoto-9',
    name: '祇園 / 花見小路 (Gion / Hanamikoji)',
    country: 'JP',
    category: 'Public Facility',
    ...
    imageUrl: parkImg,
    amenities: ['family_toilet'],
    description: '適合文化逛街：親子可以一起體驗京都的傳統町家氛圍、買和風紀念品、拍照。',
    openingHours: '24 Hours',
    websiteUrl: '',
    coordinates: { lat: 35.0010, lng: 135.7750 }
  },
  {
    id: 'jp-kyoto-10',
    name: '二年坂 / 三年坂 (Ninenzaka / Sannenzaka)',
    country: 'JP',
    category: 'Public Facility',
    ...
    imageUrl: parkImg,
    amenities: ['family_toilet'],
    description: '親子一起「慢旅行」的好地點：可以逛特色小店、買小陶瓷或小飾品，也可以拍美照。',
    openingHours: '10:00 - 18:00',
    websiteUrl: '',
    coordinates: { lat: 34.9965, lng: 135.7800 }
  },
  {
    id: 'jp-kyoto-11',
    name: '堀川商店街',
    country: 'JP',
    category: 'Public Facility',
    address: 'Horikawa-dori, Kamigyo Ward, Kyoto',
    city: 'Kyoto',
    imageUrl: mallImg,
    amenities: ['family_toilet'],
    description: '是比較在地型的商店街，可以讓孩子體驗京都人的小店文化。',
    openingHours: '10:00 - 19:00',
    websiteUrl: 'http://www.horikawa-shotengai.com/',
    coordinates: { lat: 35.0250, lng: 135.7520 }
  },
  {
    id: 'jp-kyoto-12',
    name: 'JR 京都伊勢丹 (Isetan Kyoto)',
    country: 'JP',
    category: 'Department Store',
    address: 'Higashi-Shiokoji-cho, Karasuma-dori Shiokoji Sagaru, Shimogyo Ward, Kyoto',
    city: 'Kyoto',
    imageUrl: mallImg,
    amenities: ['nursing_room', 'elevator', 'diaper_changing', 'family_toilet', 'stroller_rental'],
    description: '百貨型，品牌多、伴手禮、服飾都齊全。',
    openingHours: '10:00 - 20:00',
    websiteUrl: 'https://kyoto.wjr-isetan.co.jp/',
    coordinates: { lat: 34.9855, lng: 135.7585 }
  },
  {
    id: 'jp-kyoto-13',
    name: '京都 Porta 地下街',
    country: 'JP',
    category: 'Department Store',
    address: '902 Higashishiokojicho, Shimogyo Ward, Kyoto',
    city: 'Kyoto',
    imageUrl: mallImg,
    amenities: ['nursing_room', 'elevator', 'diaper_changing', 'family_toilet'],
    description: '地下商場很適合逛紀念品、零食、雜貨。',
    openingHours: '11:00 - 20:30',
    websiteUrl: 'https://www.porta.co.jp/',
    coordinates: { lat: 34.9860, lng: 135.7590 }
  },
  {
    id: 'jp-kyoto-14',
    name: '永旺夢樂城 Kyoto (Aeon Mall Kyoto)',
    country: 'JP',
    category: 'Department Store',
    ...
    imageUrl: mallImg,
    amenities: ['nursing_room', 'elevator', 'diaper_changing', 'family_toilet', 'stroller_rental', 'play_area'],
    description: '非常親子友善，有超市、生活用品、餐飲，非常適合家庭一起逛。',
    openingHours: '10:00 - 21:00',
    websiteUrl: 'https://kyoto-aeonmall.com/',
    coordinates: { lat: 34.9810, lng: 135.7560 }
  },
  {
    id: 'jp-kyoto-15',
    name: '平等院表參道',
    ...
    imageUrl: parkImg,
    amenities: ['family_toilet'],
    description: '文化氛圍濃，和風紀念品、小點心、抹茶店都很多，是親子文化旅 +購物混搭的好點。',
    openingHours: '10:00 - 17:00',
    websiteUrl: '',
    coordinates: { lat: 34.8900, lng: 135.8080 }
  },
  {
    id: 'jp-kyoto-16',
    name: '先斗町通 (Pontocho Alley)',
    country: 'JP',
    category: 'Public Facility',
    ...
    imageUrl: parkImg,
    amenities: [],
    description: '適合傍晚 /夜間散步 +購物：小孩子可以體驗古都夜色 +小型特色店，是很有氛圍的地點。',
    openingHours: '17:00 - 23:00',
    websiteUrl: 'https://www.ponto-cho.com/',
    coordinates: { lat: 35.0055, lng: 135.7710 }
  },
