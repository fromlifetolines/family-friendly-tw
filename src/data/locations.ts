...
export const locations: Location[] = [
  ...
  },
  {
    ...
    navLat: 25.0705, navLng: 121.3658, // Parking Entrance
    ...
    facilities: [
      { id: 'nursing_room', available: true },
      { id: 'stroller_rental', available: true, note: '1F 服務台' },
      { id: 'diaper_table', available: true },
      { id: 'hot_water', available: true },
      { id: 'elevator', available: true },
      { id: 'play_area', available: true },
  ...
  },
  {
    ...
    branch: '3F 兒童區',
    type: 'mall',
    lat: 25.0725, lng: 121.3645,
    navLat: 25.0722, navLng: 121.3644, // Parking Entrance
  ...
  // ── 交通樞紐 ──
  {
    ...
    officialWebsiteUrl: 'https://www.railway.gov.tw/tra-tip-web/tip/tip00H/tipH41/viewStaInfo/1000',
  },
  {
  ...
  },
  {
    ...
    branch: '2F 穿堂層',
    type: 'transport',
    lat: 25.0601, lng: 121.3681,
    navLat: 25.0601, navLng: 121.3681,
    address: '桃園市龜山區文化一路1號',
    phone: '03-286-8789',
    openHours: '06:00–24:00',
    isPremium: false,
    ...
    lastUpdated: '2025-01-20',
    photos: ['https://images.unsplash.com/photo-1563223771-5fe4038fbfc9?auto=format&fit=crop&q=80&w=1200&h=675'],
    officialWebsiteUrl: 'https://www.tymetro.com.tw/tymetro-new/tw/_pages/travel-guide/road.html?id=10',
  },
  {
    id: 'mrt-a9',
    name: '機場捷運 A9 林口站',
    branch: '3F 穿堂層',
    type: 'transport',
    lat: 25.0664, lng: 121.3618,
    navLat: 25.0664, navLng: 121.3618,
    address: '新北市林口區文化三路一段2號',
    phone: '03-286-8789',
    openHours: '06:00–24:00',
    isPremium: false,
    rating: 4.1, reviewCount: 65,
    floorInfo: '3F',
    facilities: [
      { id: 'nursing_room', available: true },
      { id: 'stroller_rental', available: false },
    ...
    lastUpdated: '2025-01-20',
    photos: ['https://images.unsplash.com/photo-1563223771-5fe4038fbfc9?auto=format&fit=crop&q=80&w=1200&h=675'],
    officialWebsiteUrl: 'https://www.tymetro.com.tw/tymetro-new/tw/_pages/travel-guide/road.html?id=11',
  },
  {
    id: 'thsr-taipei',
    name: '高鐵台北站',
    ...
    lastUpdated: '2025-01-20',
    photos: ['https://images.unsplash.com/photo-1541882662059-eeb522ddbf3c?auto=format&fit=crop&q=80&w=1200&h=675'],
    officialWebsiteUrl: 'https://www.thsrc.com.tw/ArticleContent/2f940836-cedc-41ef-8e28-c2336ac8fe68',
  },
  {
    id: 'thsr-taoyuan',
    name: '高鐵桃園站',
    ...
    lastUpdated: '2025-01-20',
    photos: ['https://images.unsplash.com/photo-1541882662059-eeb522ddbf3c?auto=format&fit=crop&q=80&w=1200&h=675'],
    officialWebsiteUrl: 'https://www.thsrc.com.tw/ArticleContent/fbd828d8-b1da-4b06-a3bd-680cdca4d2cd',
  },
  ...
  // ── 醫療院所 ──
  {
    ...
    navLat: 25.0610, navLng: 121.3670, // Entrance navigation
    address: '桃園市龜山區復興街5號',
    phone: '03-328-1200',
    openHours: '24 小時',
    isPremium: false,
  ...
  },
  {
    ...
    branch: '醫學大樓 1F',
    type: 'hospital',
    lat: 25.0592, lng: 121.3685,
    navLat: 25.0595, navLng: 121.3690, // Medical building navigation
    address: '桃園市龜山區復興街5號',
    phone: '03-328-1200',
    openHours: '24 小時',
    isPremium: false,
    rating: 4.0, reviewCount: 124,
    floorInfo: '醫學大樓 1F',
    facilities: [
      { id: 'nursing_room', available: true },
      { id: 'stroller_rental', available: true },
  ...
  },
  {
    ...
    lastUpdated: '2025-01-15',
    officialWebsiteUrl: 'https://www.ntuh.gov.tw/ntuh/ntuh_building.jsp',
  },
